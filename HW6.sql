...
ALTER TABLE alumnos
MODIFY COLUMN CedIdentidad VARCHAR(30);
-- drop table Alumnos;
-- Drop table Cohorte;
...
-- delete from carrera where carreraid = '4';
...
INSERT instructores (CedIdentidad, nombre, apellido, F_Nacimiento, F_Incorporacion) 
...
INSERT INTO cohorte (Codigo, Carrera, F_Inicio, F_Finalizacion, Instructor)
VALUES ('FT-1235',1,'2020-2-1','2020-6-30',1);
delete from cohorte where id_cohorte = 1247;

INSERT INTO alumnos (ID_AL,CedIdentidad,nombre,apellido,F_nacimiento,F_ingreso,Cohorte)
...
VALUES (41,'492795224','Amir','Marks','1988-09-12','2021-01-04',1237),
  ...
  select * from cohorte where ID_cohorte=1245;
  delete from cohorte where ID_cohorte=1245;
  delete from cohorte where ID_cohorte=1246;
